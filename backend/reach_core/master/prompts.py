...
def generate_report_prompt(question, context, report_format="apa", total_words=2000, retained_text="", deleted_text="", cadence=""):
    ...
    return f'Information: """{context}""".\n' \
           ...
           "You must write the report with markdown syntax. Using headings, bulleted lists, tables, block quotes to highlight important points or themes, and other markdown formatted features when appropriate.\n " \
           f"Use an unbiased and journalistic tone. \n" \
           "You MUST determine your own concrete and valid opinion based on the given information. Do NOT deter to general and meaningless conclusions.\n" \
