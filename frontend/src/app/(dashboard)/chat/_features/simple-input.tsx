    ...
    <div className="absolute bottom-2 md:bottom-8 left-0 right-0 px-4">
      <div className="relative max-w-3xl mx-auto flex items-center">
        <input
          ...
          className="w-full p-3 rounded-l-md border text-lg border-stone-300 dark:border-stone-600 bg-brand dark:bg-brand text-black dark:text-white focus:outline-none shadow-md"
        />
        {isLoading ? (
