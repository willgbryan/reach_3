...
interface PopoverTriggerProps {
  ...
  export function PopoverTrigger({ children, className, asChild = false }: PopoverTriggerProps) {
    ...
    const triggerProps = asChild ? {} : {
      ...
      onClick: openPopover,
      className: cn(
        "flex items-center justify-center px-3 py-2 bg-stone-900 dark:bg-stone-100 text-sm font-medium text-stone-100 dark:text-stone-900 hover:bg-stone-300 dark:hover:bg-stone-600 transition-colors rounded-full",
        className
      ),
    };
