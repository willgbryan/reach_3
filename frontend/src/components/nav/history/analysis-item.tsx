...
export function AnalysisItem({ index, analysis, children, onSelect }: AnalysisItemProps) {
  ...
  const firstFileName = analysis.filePaths[0]?.split('/').pop() || 'Untitled Document'
    ...
    >
      ...
      >
        ...
        <div className="relative z-40 p-8 h-full w-full flex flex-col items-center">
          <motion.div className="flex flex-row items-center" variants={titleVariants}>
            ...
            <p className="ml-2 text-neutral-800 dark:text-neutral-200 group-hover:text-white text-base md:text-lg font-medium font-sans text-center transition-colors duration-300">
              {firstFileName}
            </p>
          </motion.div>
